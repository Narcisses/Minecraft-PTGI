...
const bool colortex6Clear = false; // History position data
...
colortex6: History position + depth (SVGF, Temporal)
colortex7: History normal data + block ID (SVGF, Temporal)
colortex8: History moments (luminance, square luminance) + pixel age (SVGF, Temporal)
colortex9: -
